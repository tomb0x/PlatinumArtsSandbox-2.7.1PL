...
namespace game
{
    ...
    void drawhudmodel(fpsent *d, int anim, float speed = 0, int base = 0)
    {
        ...
        defformatstring(gunname)("%s/%s", hudgunsdir[0] ? hudgunsdir : mdl.hudguns, "hands");//guns[d->gunselect].file);
        ...
        rendermodel(NULL, gunname, anim, sway, testhudgun ? 0 : d->yaw+90, testhudgun ? 0 : d->pitch, 0, MDL_LIGHT|MDL_HUD, interp, a, base, (int)ceil(speed));
